...
describe('validation middleware for update and patch operations', () => {
  ...
  describe('update operation with validation', () => {
    beforeEach(() => {
      app.use('/update-test', update(TestModel, { validate: true }));
    });
  ...
  describe('patch operation with validation', () => {
    beforeEach(() => {
      app.use('/patch-test', patch(TestModel, { validate: true }));
    });
  ...
  describe('without validation (default)', () => {
    ...
    test('patch should not validate when disabled', async () => {
      const res = await request(app)
        .patch('/no-validation-patch/1')
        .send({
          age: 40
        });
