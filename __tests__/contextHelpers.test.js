    ...
    app.use(
      ...
      list(Item, {
        pre: async (context) => {
          ...
          context.apply_where({ price: { [Op.gt]: 100 } });
  ...
  test('req.apialize.applyScope should apply Sequelize scopes', async () => {
    app.use(
      ...
      list(Item, {
        pre: async (context) => {
          ...
          context.apply_scope('byTenant', 1);
    ...
    expect(
      response.body.data.every(
        (item) => item.tenant_id === 1 && item.status === 'active'
      )
    ).toBe(true);
  });
    ...
    app.use(
      ...
      list(Item, {
        pre: async (context) => {
          ...
          context.apply_where({ tenant_id: 2 });
    ...
    app.use(
      ...
      list(Item, {
        pre: async (context) => {
          ...
          context.apply_where({ tenant_id: 1 });
          context.apply_where({ status: 'active' });
          context.apply_where({ status: 'inactive' }); // Should overwrite active
